    ...
    <div class="wcu-container">
      <article class="wcu-card overflow-hidden border-secondary/30">
        ...
        <div class="card-body p-6 md:p-8">
          <p class="wcu-eyebrow mb-2">Membership</p>
          <h1 class="text-2xl md:text-3xl font-bold text-base-content">Member Dashboard</h1>
          <p class="mt-3 text-base-content/85">
            This dashboard foundation is now wired for server-backed auth and dues visibility.
          </p>
        </div>
      </article>
    </div>
