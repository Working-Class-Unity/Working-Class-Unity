...
<template>
  <div class="min-h-screen bg-base-100">
    <!-- Hero Section -->
    <section class="py-6 md:py-12 bg-gradient-to-b from-base-200 to-base-100">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <header class="text-center mb-7 md:mb-8">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-7 md:py-8 space-y-10 md:space-y-12">
      ...
      <section aria-labelledby="before-heading">
        <div class="flex items-center gap-3 mb-6">
          ...
          <h2 id="before-heading" class="text-xl sm:text-2xl font-bold text-base-content">{{ $t('volunteer_guide.before.title') }}</h2>
        </div>
      ...
      <section aria-labelledby="getting-there-heading">
        <div class="flex items-center gap-3 mb-6">
          ...
          <h2 id="getting-there-heading" class="text-xl sm:text-2xl font-bold text-base-content">{{ $t('volunteer_guide.location.title') }}</h2>
        </div>
          ...
          <div class="card bg-base-100 border border-base-300 shadow-sm hover:border-primary/50 focus-within:border-primary/50 focus-within:ring-2 focus-within:ring-primary/20 transition-colors">
            <div class="card-body">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                class="btn btn-primary h-10 min-h-10 px-3 text-sm gap-2"
              >
      ...
      <section aria-labelledby="during-heading">
        <div class="flex items-center gap-3 mb-6">
          ...
          <h2 id="during-heading" class="text-xl sm:text-2xl font-bold text-base-content">{{ $t('volunteer_guide.during.title') }}</h2>
        </div>
      ...
      <section aria-labelledby="safety-heading">
        <div class="flex items-center gap-3 mb-6">
          ...
          <h2 id="safety-heading" class="text-xl sm:text-2xl font-bold text-base-content">{{ $t('volunteer_guide.safety.title') }}</h2>
        </div>
      ...
      <section aria-labelledby="end-shift-heading">
        <div class="flex items-center gap-3 mb-6">
          ...
          <h2 id="end-shift-heading" class="text-xl sm:text-2xl font-bold text-base-content">{{ $t('volunteer_guide.end_shift.title') }}</h2>
        </div>
            ...
            <div class="card bg-base-200 border border-base-300 hover:border-primary/50 focus-within:border-primary/50 focus-within:ring-2 focus-within:ring-primary/20 transition-colors">
              <div class="card-body">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  class="btn btn-outline h-10 min-h-10 px-3 text-sm gap-2"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
      ...
      <section aria-labelledby="contacts-heading">
        <div class="flex items-center gap-3 mb-6">
          ...
          <h2 id="contacts-heading" class="text-xl sm:text-2xl font-bold text-base-content">{{ $t('volunteer_guide.contacts.title') }}</h2>
        </div>
      ...
      <section aria-labelledby="responses-heading">
        <div class="flex items-center gap-3 mb-6">
          ...
          <h2 id="responses-heading" class="text-xl sm:text-2xl font-bold text-base-content">{{ $t('volunteer_guide.responses.title') }}</h2>
        </div>
