...
function configureRuntime(databasePath: string) {
  const environment = {
    ...
    NUXT_STRIPE_PERSONAL_WEEKLY_PRICE_ID: 'price_account_deletion_personal_weekly',
    NUXT_STRIPE_PERSONAL_MONTHLY_PRICE_ID: 'price_account_deletion_personal_monthly',
