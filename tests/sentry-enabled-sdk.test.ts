...
function stubRuntimeEnvironment(dsn: string) {
  const environment = {
    ...
    NUXT_TWILIO_VERIFY_API_KEY_SID: 'SK77777777777777777777777777777777',
    NUXT_TWILIO_VERIFY_API_KEY_SECRET: 'sentry-twilio-secret-not-a-credential',
    NUXT_TWILIO_VERIFY_SERVICE_SID: 'VA77777777777777777777777777777777',
